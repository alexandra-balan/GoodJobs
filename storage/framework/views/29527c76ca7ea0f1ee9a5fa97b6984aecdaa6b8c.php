...
<head>
    ...
    <title><?php echo e(config('app.name', 'GoodJobs')); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <?php echo e(config('app.name', 'GoodJobs')); ?>
...
<?php /**PATH C:\Alexandra\LicentaStefi\kidlearn\resources\views/layouts/app.blade.php ENDPATH**/ ?>